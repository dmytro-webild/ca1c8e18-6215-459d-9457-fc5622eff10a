  ...
  return (
    <ThemeProvider defaultButtonVariant="hover-magnetic" defaultTextAnimation="entrance-slide" borderRadius="rounded" contentWidth="medium" sizing="medium" background="circleGradient" cardStyle="glass-elevated" primaryButtonStyle="gradient" secondaryButtonStyle="glass" headingFontWeight="normal">
      ...
      <div id="solution" data-section="solution">
        <TestimonialAboutCard tag="Lösung" title="Automation" description="Wir helfen dir." subdescription="." icon={Zap} videoSrc="https://www.youtube.com/watch?v=dQw4w9WgXcQ&_wi=1" useInvertedBackground={false} mediaAnimation="none" />
      </div>
      ...
      <div id="about" data-section="about">
        <TestimonialAboutCard tag="Über uns" title="VoiceLinkAI" description="Expertise." subdescription="." icon={Info} videoSrc="https://www.youtube.com/watch?v=dQw4w9WgXcQ&_wi=2" useInvertedBackground={false} mediaAnimation="none" />
      </div>
